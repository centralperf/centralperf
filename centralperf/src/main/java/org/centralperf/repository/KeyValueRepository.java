...
/**
 * KeyValue Spring Data (http://projects.spring.io/spring-data-jpa/) based repository
 * @since 1.0
 */
public interface KeyValueRepository extends PagingAndSortingRepository<KeyValue, Long> {
	
	/**
	 * Return the value associated to a specific key
	 * @param key	The name of the key
	 * @return	Value stored in the database for this key
	 */
