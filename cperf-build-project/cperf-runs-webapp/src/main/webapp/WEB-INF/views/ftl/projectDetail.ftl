...
<@layout.main title="Project detail" menu="projects">
    ...
    <div>
        <legend>Last runs<div style="float: right"><a href="#" id="newRun" class="btn btn-primary" projectId="${project.id}">New run</a></div></legend>
        <@run_list.main/>
    </div>
    <div>
        <legend>Scripts<div style="float: right"><a href="#" id="newScript" class="btn btn-primary" projectId="${project.id}">New script</a></div></legend>
        <@script_list.main project/>
    </div>
</@layout.main>